...
*          AS WELL AS LE/370
*          THIS PROGRAM IS RE-ENTRANT AND REFRESHABLE.
         PUSH  PRINT
         PRINT NOGEN
&NL      SETC  BYTE(21)
&TAB     SETC  BYTE(05)
...
BALR     OPSYN BASR
         ...
         SYSSTATE ASCENV=P,
               AMODE64=NO,
               ARCHLVL=2
OPERCMD CEEENTRY PPA=OPERCMD_PPA,
               MAIN=YES,
               AUTO=DSASIZE,
               BASE=R11_32
OPERCMD ALIAS C'skeleton'
         USING CEECAA,R12_32
         USING CEEDSA,R13_32
         J     GO
GOBACK   DS    0H
...
MSGFMT1  DC    C'Hello! I was given %i parameters.&NL.&NULL.'
TOHEX    DC    C'0123456789ABCDEF'
TAB      DC    X'05'
NL       DC    X'15'
TITLE    DC    CL80'OPERCMD DUMP'
